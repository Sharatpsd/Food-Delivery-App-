...
export default function RestaurantDetail() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="flex items-center gap-3 rounded-2xl border border-emerald-100 bg-white px-4 py-3 shadow-2xl">
          ...
          <button
            ...
            className="rounded-lg bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-100"
          >
            View
          </button>
        </div>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <button
            type="button"
            onClick={handleBack}
            className="inline-flex items-center gap-2 rounded-xl border border-white/30 bg-white/15 px-4 py-2 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/25"
          >
            <ArrowLeft size={18} />
            Back
          </button>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-10">
          ...
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-3">{restaurant.city}</p>
            ...
            <p className="mt-3 text-gray-600">{restaurant.theme}</p>
          </div>
        </div>

        <h2 className="text-3xl font-bold mb-6">Menu</h2>

        {foods.length === 0 && <p className="text-gray-500">No food available</p>}
          ...
          {foods.map((item) => {
            ...
            return (
              <div key={item.id} className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <p className="text-gray-500 mb-2">{item.category || "Food"}</p>
